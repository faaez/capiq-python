...
class TestCapiqClientGdst(unittest.TestCase):
    ...
    @mock.patch('capiq_client.capiq_client.requests.post', side_effect=mocked_gdst_data_requests_post)
    ...
    @mock.patch('capiq_client.capiq_client.requests.post', side_effect=mocked_gdst_no_data_requests_post)
