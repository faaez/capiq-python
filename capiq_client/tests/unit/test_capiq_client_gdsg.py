...
class TestCapiqClientGdsg(unittest.TestCase):
    ...
    @mock.patch('capiq_client.capiq_client.requests.post', side_effect=mocked_gdsg_data_requests_post)
    ...
    @mock.patch('capiq_client.capiq_client.requests.post', side_effect=mocked_gdsg_no_data_requests_post)
